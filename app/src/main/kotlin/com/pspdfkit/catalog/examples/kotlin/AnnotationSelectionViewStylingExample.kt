 ...
 * ```
 */
private inline fun build(annotationSelectionViewThemeConfiguration: AnnotationSelectionViewThemeConfiguration,
                 block: AnnotationSelectionViewThemeConfiguration.Builder.() -> Unit) = AnnotationSelectionViewThemeConfiguration.Builder(annotationSelectionViewThemeConfiguration).apply(block).build()